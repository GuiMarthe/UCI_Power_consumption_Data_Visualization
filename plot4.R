#### This script will load the data from your data folder and create the plot4.
...
#### Creating plot4 : Small 4 by 4 dash board 
...
par(mfrow = c(2,2))
plot(df$Date_Time, df$Global_active_power, type = "l", main = "", xlab = "", ylab = "Global Active Power")


# second plot

plot(df$Date_Time, df$Voltage, type = "l", main = "", xlab = "", ylab = "Voltage")
...
plot(df$Date_Time, df$Global_reactive_power, type = "l", main = "", xlab = "", ylab = "Global Reactive Power")
